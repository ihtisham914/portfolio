    ...
    slides: [
      {
        ...
        header: "This was awsome to work with him",
...
<template>
  <div class="container glass">
    <h3 class="heading">Kind words from customers</h3>
    <div class="review glass">
      <div class="slider">
        <div class="slide" :v-for="slide in slides">
          <div class="testimonial">
            <h5 class="testimonial__header">{{ slide.header }}</h5>
            <blockquote class="testimonial__text">{{ slide.text }}</blockquote>
            <address class="testimonial__author">
              <img v-bind:src="slide.image" alt="" class="testimonial__photo" />
              <h6 class="testimonial__name">{{ slide.name }}</h6>
              <p class="testimonial__location">{{ slide.location }}</p>
            </address>
          </div>
        </div>
